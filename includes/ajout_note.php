        ...
        if($math >= 20 || $physic >= 20 || $info >= 20 || $chimie >= 20){
            ...
            if ($moyenne >= 10) {
                ...
                try {
                    ...
                    $message = "Ajouts des Notes de l'Etudiant Reussi !!";
...
<body>
    <div class="container">
        <h1>Ajouter les Notes de l'Etudiants</h1>
        <?php if (!empty($error)): ?>
        ...
        <form method="post">
            ...
            <label>Physic : /20
                <input type="number" name="physic" step="any" required>
            </label>
            <label>Informatique : /20
                <input type="number" name="info" step="any" required>
            </label>
            <label>Chimie : /20
                <input type="number" name="chimie" step="any" required>
            </label>
